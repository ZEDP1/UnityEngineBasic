...
namespace ClassObjectinstance
{
    ...
    internal class SwordMan
    {
        ...
        // inturnal : 동일 어셈블리(프로젝트)에서 제한없이 접근가능
        // private : 타 클래스 접근 불가능
        // 클래스는 기본적으로 캡슐화를 위한 타입이기때문에
        // 접근자가 명시되지 않을경우에 defalt 접근제한자는 private임.
        ...
        // 따로 정의하지 않아도 Defalt 생성자는 클래스 정의하면 생성됨.
        public SwordMan()
        {
        ...
        // 소멸자
        // 해당 객체가 할당된 영역의 메모리를 해제할때 호출하는 함수
        // 해당 객체가 더이상 참조되지 않을때 .Net 의 CLR 의 GarbageCollector 가 
        // 알아서 호출해주기 때문에 직접 호출할일 없음.
